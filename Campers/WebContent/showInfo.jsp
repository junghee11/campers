...
<div id="mid" >
  <div class="container" style="width:900px; margin: 0 auto; display: flex;">
      <div style="width: 450px; height: 150px; margin: 120px auto; text-align: center; border: 1px solid gray; padding: 10px 30px;">
      <% 
      	String id = (String)request.getAttribute("id");
      	String pw = (String)request.getAttribute("pw");
      	if(id != null) { 
      	%>
      	<p style="font-weight: 600; color:lightsalmon; line-height: 120px;">고객님의 아이디는 <%=id %> 입니다.</p>
	  <% } else if(pw != null) { 
	    
	  %>
        <p style="font-weight: 600; color:lightsalmon; line-height: 120px;">고객님의 비밀번호는 <%=pw %> 입니다.</p>
      <% } else {  %>
        <p style="font-weight: 600; color:lightsalmon; line-height: 120px;">입력하신 정보로는 고객님을 확인할 수 없습니다. 다시 확인해주세요.</p>
      <% } %>
      </div>
    </div>
  </div>
