...
<div id="mid">
    <div class="container">
       ...
       <div style="margin-top : 5px;">
           <form id="writeContent" action="write.do">
           		<h4>후기 작성하기</h4>
               <table>
                       <!-- 작성자id -->
                       <td><input type="hidden" name="rName" size="50" value="<%=id %>"></td>
                   <tr>
                       <td style="height:40px; line-height: 70px; width: 110px; text-align: center; font-weight: 600;">제품명</td>
                       <td>
                           <!-- <label for=""></label> -->
                           <select name="rTitle" id="">
                           <option value="tent1">텐트</option>
                           <option value="cook1">조리도구</option>
                           <option value="furniture1">가구</option>
                           <option value="sleep1">침낭</option>
                           </select>
                       </td>
                   </tr>
                   <tr sytle="height:350px;">
                       <td style="text-align: center; font-weight: 600;">내용</td>
                       <td><textarea name="rContent" rows="10"></textarea></td>
                   </tr>
